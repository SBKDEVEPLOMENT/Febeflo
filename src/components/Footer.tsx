  ...
  return (
    <footer className="bg-black text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <ul className="space-y-2">
              <li>
                <a 
                  ...
                  className="flex items-start hover:text-gray-300 transition-colors"
                >
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://wa.me/56935355621" target="_blank" rel="noopener noreferrer" className="hover:text-secondary transition-colors">
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="h-6 w-6"
        ...
        <div className="border-t border-primary/50 mt-8 pt-8 text-center text-sm">
